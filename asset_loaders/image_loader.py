...
class Images:
    ...
    bubble_img_0 = pygame.image.load(os.path.join(dynamic_tile_images_path, "bubble_frame_0.png")).convert_alpha()
    bubble_img_1 = pygame.image.load(os.path.join(dynamic_tile_images_path, "bubble_frame_1.png")).convert_alpha()
    bubble_img_2 = pygame.image.load(os.path.join(dynamic_tile_images_path, "bubble_frame_2.png")).convert_alpha()
    bubble_img_3 = pygame.image.load(os.path.join(dynamic_tile_images_path, "bubble_frame_3.png")).convert_alpha()
    bubble_img_4 = pygame.image.load(os.path.join(dynamic_tile_images_path, "bubble_frame_4.png")).convert_alpha()
    bubble_img_5 = pygame.image.load(os.path.join(dynamic_tile_images_path, "bubble_frame_5.png")).convert_alpha()
    bubble_img_6 = pygame.image.load(os.path.join(dynamic_tile_images_path, "bubble_frame_6.png")).convert_alpha()
    bubble_img_7 = pygame.image.load(os.path.join(dynamic_tile_images_path, "bubble_frame_7.png")).convert_alpha()
    bubble_img_8 = pygame.image.load(os.path.join(dynamic_tile_images_path, "bubble_frame_8.png")).convert_alpha()
    bubble_img_9 = pygame.image.load(os.path.join(dynamic_tile_images_path, "bubble_frame_9.png")).convert_alpha()
    bubble_img_10 = pygame.image.load(os.path.join(dynamic_tile_images_path, "bubble_frame_10.png")).convert_alpha()
    bubble_img_11 = pygame.image.load(os.path.join(dynamic_tile_images_path, "bubble_frame_11.png")).convert_alpha()
