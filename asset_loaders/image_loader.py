...
class Images:
    ...
    pause_menu_bg_img = pygame.image.load(os.path.join(menu_images_path, "pause_menu_bg.png")).convert_alpha()
    ...
    resume_btn_img = pygame.image.load(os.path.join(menu_images_path, "resume_btn.png")).convert_alpha()
    resume_btn_hvr_img = pygame.image.load(os.path.join(menu_images_path, "resume_btn_hover.png")).convert_alpha()
    level_select_btn_img = pygame.image.load(os.path.join(menu_images_path, "level_select_btn.png")).convert_alpha()
    level_select_btn_hvr_img = pygame.image.load(os.path.join(menu_images_path, "level_select_btn_hover.png")).convert_alpha()
    reset_btn_img = pygame.image.load(os.path.join(menu_images_path, "reset_btn.png")).convert_alpha()
