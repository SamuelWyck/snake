...
class TileConfig:
    ...
    tile_args_map = {
        ...
        "P0": {"b": ["+0", Color.BLUE], "o": ["+0", Color.ORANGE], "g": ["+0", Color.GREEN], "r": ["+0", Color.RED], "NOCOLOR": ["+0", Color.NO_COLOR]},
        "P1": {"b": ["+1", Color.BLUE], "o": ["+1", Color.ORANGE], "g": ["+1", Color.GREEN], "r": ["+1", Color.RED], "NOCOLOR": ["+1", Color.NO_COLOR]},
        "PN1": {"b": ["-1", Color.BLUE], "o": ["-1", Color.ORANGE], "g": ["-1", Color.GREEN], "r": ["-1", Color.RED], "NOCOLOR": ["-1", Color.NO_COLOR]},
        "P2": {"b": ["+2", Color.BLUE], "o": ["+2", Color.ORANGE], "g": ["+2", Color.GREEN], "r": ["+2", Color.RED], "NOCOLOR": ["+2", Color.NO_COLOR]},
        "PN2": {"b": ["-+2", Color.BLUE], "o": ["-2", Color.ORANGE], "g": ["-2", Color.GREEN], "r": ["-2", Color.RED], "NOCOLOR": ["-2", Color.NO_COLOR]},
        "P3": {"b": ["+3", Color.BLUE], "o": ["+3", Color.ORANGE], "g": ["+3", Color.GREEN], "r": ["+3", Color.RED], "NOCOLOR": ["+3", Color.NO_COLOR]},
        "PN3": {"b": ["-3", Color.BLUE], "o": ["-3", Color.ORANGE], "g": ["-3", Color.GREEN], "r": ["-3", Color.RED], "NOCOLOR": ["-3", Color.NO_COLOR]},
        "P4": {"b": ["+4", Color.BLUE], "o": ["+4", Color.ORANGE], "g": ["+4", Color.GREEN], "r": ["+4", Color.RED], "NOCOLOR": ["+4", Color.NO_COLOR]},
        "PN4": {"b": ["-4", Color.BLUE], "o": ["-4", Color.ORANGE], "g": ["-4", Color.GREEN], "r": ["-4", Color.RED], "NOCOLOR": ["-4", Color.NO_COLOR]},
        "P5": {"b": ["+5", Color.BLUE], "o": ["+5", Color.ORANGE], "g": ["+5", Color.GREEN], "r": ["+5", Color.RED], "NOCOLOR": ["+5", Color.NO_COLOR]},
        "PN5": {"b": ["-5", Color.BLUE], "o": ["-5", Color.ORANGE], "g": ["-5", Color.GREEN], "r": ["-5", Color.RED], "NOCOLOR": ["-5", Color.NO_COLOR]},
        "G": {
